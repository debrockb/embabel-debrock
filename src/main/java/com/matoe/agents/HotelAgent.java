...
/**
 * Hotel search agent — searches Booking.com, Hotels.com, Expedia via browser-use,
...
public class HotelAgent {
    ...
    public List<AccommodationOption> searchHotels(TravelRequest request) {
        ...
        try {
            String systemPrompt = dynamicPromptService.getPrompt("hotel-agent");
            ...
            costTracker.logCall(request.sessionId(), "hotel-agent", model != null ? model : "default",
            ...
            costTracker.logCall(request.sessionId(), "hotel-agent", request.extractorModel(),
